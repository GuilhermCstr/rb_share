...
import 'package:rb_share/model/cross_file.dart';
import 'package:rb_share/model/send_mode.dart';
import 'package:rb_share/model/state/send/send_session_state.dart';
import 'package:rb_share/model/state/send/sending_file.dart';
import 'package:rb_share/pages/home_page.dart';
import 'package:rb_share/pages/progress_page.dart';
import 'package:rb_share/pages/send_page.dart';
import 'package:rb_share/provider/device_info_provider.dart';
import 'package:rb_share/provider/dio_provider.dart';
import 'package:rb_share/provider/progress_provider.dart';
...
import 'package:rb_share/util/api_route_builder.dart';
  ...
  Future<void> startSession({
    ...
    if (fileMap.isEmpty) {
      ...
      if (state[sessionId]?.background == false) {
        // ignore: use_build_context_synchronously, unawaited_futures
        Routerino.context
            .pushRootImmediately(() => const HomePage(initialTab: HomeTab.send, appStart: false));
      }
