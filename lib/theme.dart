...
import 'package:rb_share/util/ui/dynamic_colors.dart';
...
ThemeData getTheme(ColorMode colorMode, Brightness brightness, DynamicColors? dynamicColors) {
  ...
  // https://github.com/rbshare/rbshare/issues/52
  ...
  return ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder:
          colorScheme.brightness == Brightness.light ? lightInputBorder : darkInputBorder,
      enabledBorder:
          colorScheme.brightness == Brightness.light ? lightInputBorder : darkInputBorder,
