...
import 'package:rb_share/pages/receive_options_page.dart';
...
import 'package:rb_share/provider/selection/selected_receiving_files_provider.dart';
...
class _ReceivePageState extends State<ReceivePage> with Refena {
  ...
  Future<void> _init() async {
    ...
    setState(() {
      ...
      _isLink =
          _message != null && (_message!.startsWith('http://') || _message!.startsWith('https'));
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final senderFavoriteEntry = ref
        .watch(favoritesProvider)
        .firstWhereOrNull((e) => e.fingerprint == receiveSession.sender.fingerprint);
                            ...
                            children: [
                              ...
                              ElevatedButton.icon(
                                ...
                                onPressed: selectedFiles.isEmpty
                                    ...
                                    : () async {
                                        final sessionId =
                                            ref.read(serverProvider)?.session?.sessionId;
                                        if (sessionId == null) {
                                          return;
                                        }
                                        _accept();
